...
multi-agent AI systems, NLP-based recruitment automation, and healthcare digitalization.
...
[![Portfolio](https://img.shields.io/badge/Portfolio-000?style=flat&logo=vercel&logoColor=white)](https://portfolio-delta-swart-14.vercel.app)
...
|---------|-------|-------------|
| [MultiAgent Roadmap](https://github.com/Nourhene123/MultiAgent-Roadmap) | LangChain · LangGraph · Azure OpenAI · FastAPI · Next.js | AI-powered certification planner with 6 specialized agents, profile assessment, and personalized roadmap generation |
| [MedFlow](https://github.com/Nourhene123/MedFlow-frontend) | Next.js · Django · Stripe · K8s · BioMistral AI | Healthcare SaaS platform — clinic digitalization with 5-role RBAC, real-time scheduling, and AI diagnostics |
...
| [HR Automation](https://github.com/Nourhene123/HR-automatin-frontend-) | .NET · Angular · Ollama/Phi3 · SQL Server | HR platform with AI-driven candidate screening and CV parsing |
| [University Management](https://github.com/Nourhene123/UniversityManagementAppBackend) | Spring Boot 3.5 · Angular 16 · PostgreSQL · JWT | Academic platform with role-based dashboards, grade analytics, and PDF report generation |
...
| [Portfolio](https://portfolio-delta-swart-14.vercel.app) | React 19 · Tailwind · Framer Motion · Vercel | Personal portfolio with 3D tilt cards, particle effects, and lazy loading |
